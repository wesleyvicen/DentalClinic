...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  /***
   * Método para autorizar acesso aos endpoints que precisam de autenticação, sem configuração de
   * ataque CSRF pois o sistema é stateless e sem criar seção de usuário.
   */
  @Override
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf().disable();
    http.cors().and().authorizeRequests().antMatchers(HttpMethod.GET, PUBLIC_MATCHERS_GET)
        .permitAll().antMatchers(HttpMethod.POST, PUBLIC_MATCHERS_POST).permitAll()
        .antMatchers(PUBLIC_MATCHERS).permitAll().antMatchers(SWAGGER_WHITELIST).permitAll()
  ...
  CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration
        .setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "OPTIONS", "DELETE", "HEAD"));
   ...
   * source = new UrlBasedCorsConfigurationSource(); CorsConfiguration corsConfiguration = new
   * CorsConfiguration(); corsConfiguration.addAllowedMethod(HttpMethod.GET);
   * corsConfiguration.addAllowedMethod(HttpMethod.POST);
   * corsConfiguration.addAllowedMethod(HttpMethod.PUT);
   * corsConfiguration.addAllowedMethod(HttpMethod.DELETE);
   * corsConfiguration.addAllowedMethod(HttpMethod.OPTIONS);
   * corsConfiguration.addAllowedMethod(HttpMethod.HEAD); corsConfiguration.addAllowedOrigin("**");
   * corsConfiguration.addAllowedOrigin("/**"); source.registerCorsConfiguration("/**",
