...
@Entity public class Usuario implements Serializable {
    ...
    @Column(nullable = false, length = 82) private String login;
    @JsonIgnore @Column(nullable = false, length = 255) private String senha;
    ...
    @Column(name = "verification_code", length = 64) private String verificationCode;
