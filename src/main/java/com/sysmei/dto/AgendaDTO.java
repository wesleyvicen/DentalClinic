...
public class AgendaDTO implements Serializable {
    ...
    @DateTimeFormat(iso = DateTimeFormat.ISO.TIME) @JsonFormat(pattern = "yyyy-MM-dd HH:mm")
    private LocalDateTime start;
    @DateTimeFormat(iso = DateTimeFormat.ISO.TIME) @JsonFormat(pattern = "yyyy-MM-dd HH:mm")
    private LocalDateTime end;
    @DateTimeFormat(iso = DateTimeFormat.ISO.TIME) @JsonFormat(pattern = "yyyy-MM-dd")
