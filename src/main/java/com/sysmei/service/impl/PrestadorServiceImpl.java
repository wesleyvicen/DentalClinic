...
@Service public class PrestadorServiceImpl implements PrestadorService {
    ...
    public Prestador getByTelefone(String telefone) {
        ...
        if (obj.isEmpty()) {
            ...
            return obj.orElseThrow(() -> new ObjectNotFoundException(
                "Objeto Não encontrado! ID: " + finalTelefone + ", Tipo: "
                    + Prestador.class.getName()));
        }

        String finalTelefone1 = telefone;
        return obj.orElseThrow(() -> new ObjectNotFoundException(
            "Objeto Não encontrado! ID: " + finalTelefone1 + ", Tipo: "
                + Prestador.class.getName()));
    }
    ...
    @Transactional public Prestador insert(Prestador prestador) {
    ...
    @Transactional public Prestador fromDTO(PrestadorDTO dto) {
