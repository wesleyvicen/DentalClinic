...
@Entity @Table(name = "Paciente") public class Paciente implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) @Column(nullable = false) private Long
        id;
    ...
    @OneToMany(mappedBy = "paciente", cascade = CascadeType.ALL) private List<DocumentUrl>
        documentsUrl = new ArrayList<>();

    @ManyToOne() @JoinColumn(name = "login_usuario", referencedColumnName = "login") private Usuario
        usuario;

    private LocalDate nascimento;
    // Pessoa Responsavel, Apenas nome.
    private String responsavel;
    @Enumerated(EnumType.STRING) private TipoSexo sexo;
    @Enumerated(EnumType.STRING) private TipoCivil estadoCivil;
    private String indicacao;

    @Enumerated(EnumType.STRING) private TipoPlano planoSaude;
    ...
    public Paciente(String nome, String socialName, String email, String telefone1,
        String telefone2, String telefone3, LocalDate nascimento, String responsavel, TipoSexo sexo,
        TipoCivil estadoCivil, String indicacao, TipoPlano planoSaude, String convenio, String rg,
        String cpf, String ocupacao, String endereco, String enderecoNum, String bairro,
        String cidade, String estado, String cep) {
