...
//				.antMatchers(HttpMethod.POST, "/palavrashome/**").hasAnyRole("ADMIN");
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200", "http://localhost:4200/**", "https://sysmei.netlify.app", "https://sysmei.netlify.app/**", "https://dev-sysmei.netlify.app", "https://dev-sysmei.netlify.app/**"));
