...
@Service public class PacienteServiceImpl implements PacienteService {
    ...
    @Transactional public Paciente insert(Paciente paciente) {
    ...
    private void updateData(Paciente newObj, Paciente obj) {
        ...
        newObj.setSocialName(
            obj.getSocialName() == null ? newObj.getSocialName() : obj.getSocialName());
        newObj.setEmail(obj.getEmail() == null ? newObj.getEmail() : obj.getEmail());
        newObj.setTelefone1(
            obj.getTelefone1() == null ? newObj.getTelefone1() : obj.getTelefone1());
        newObj.setTelefone2(
            obj.getTelefone2() == null ? newObj.getTelefone2() : obj.getTelefone2());
        newObj.setTelefone3(
            obj.getTelefone3() == null ? newObj.getTelefone3() : obj.getTelefone3());
        newObj.setNascimento(
            obj.getNascimento() == null ? newObj.getNascimento() : obj.getNascimento());
        newObj.setResponsavel(
            obj.getResponsavel() == null ? newObj.getResponsavel() : obj.getResponsavel());
        newObj.setSexo(obj.getSexo() == null ? newObj.getSexo() : obj.getSexo());
        newObj.setEstadoCivil(
            obj.getEstadoCivil() == null ? newObj.getEstadoCivil() : obj.getEstadoCivil());
        newObj.setIndicacao(
            obj.getIndicacao() == null ? newObj.getIndicacao() : obj.getIndicacao());
        newObj.setPlanoSaude(
            obj.getPlanoSaude() == null ? newObj.getPlanoSaude() : obj.getPlanoSaude());
        ...
        newObj.setEnderecoNum(
            obj.getEnderecoNum() == null ? newObj.getEnderecoNum() : obj.getEnderecoNum());
    ...
    @Transactional public Paciente fromDTO(NewPacienteDTO dto) {
        Paciente paciente =
            new Paciente(dto.getNome(), dto.getSocialName(), dto.getEmail(), dto.getTelefone1(),
                ...
                dto.getEnderecoNum(), dto.getBairro(), dto.getCidade(), dto.getEstado(),
                dto.getCep());
        paciente.setUsuario(usuarioService.getUsuarioWithLogin(dto.getLogin_usuario()));
        return paciente;
    }

    @Transactional public URI uploadProfilePicture(Long id, MultipartFile multipartFile) {
