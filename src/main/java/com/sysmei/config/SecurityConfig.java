...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(
            Arrays.asList("http://localhost:4200", "http://localhost:4200/**",
                ...
                "https://dev-sysmei.netlify.app", "https://dev-sysmei.netlify.app/**",
                "https://dev.sysmei.com/**", "https://dev.sysmei.com", "https://api2.sysmei.com/**",
                "https://api2.sysmei.com"));
        configuration.setAllowedMethods(
            Arrays.asList("GET", "POST", "PUT", "OPTIONS", "DELETE", "HEAD"));
