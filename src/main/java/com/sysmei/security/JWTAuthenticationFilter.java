 ...
 *
 *         Classe que funciona como um filtro de autenticação impedindo que acesse os endpoints se
 *         não estiver com o usuario e senha corretos ou ainda autenticado.
 */
  ...
  public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
    ...
    try {
      ...
      UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(
          creds.getLogin(), creds.getSenha(), new ArrayList<>());
