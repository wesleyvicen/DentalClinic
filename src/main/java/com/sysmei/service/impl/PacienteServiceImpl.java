...
public class PacienteServiceImpl implements PacienteService {
  ...
  private void updateData(Paciente newObj, Paciente obj) {
    ...
    newObj
        .setSocialName(obj.getSocialName() == null ? newObj.getSocialName() : obj.getSocialName());
    ...
    newObj
        .setNascimento(obj.getNascimento() == null ? newObj.getNascimento() : obj.getNascimento());
    ...
    newObj
        .setPlanoSaude(obj.getPlanoSaude() == null ? newObj.getPlanoSaude() : obj.getPlanoSaude());
